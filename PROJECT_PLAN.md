...
| Capital-to-Production (planned) | Prescriptive AI for capital allocation under uncertainty |
| **AI-Enablement-Proof (this project)** | **A governed autonomous agent on critical infrastructure — safely** |

No other candidate in an enablement/VP AI process can make this claim with a public, reproducible artifact.
...
3. **Practitioners / hiring panels** — runnable code, evaluation harness, backtest notebooks.
4. **Recruiters / search firms** — the 13-figure catalog as a scannable visual narrative.

### 2.3 Naming rules

- **No employer names, past or present.** Anonymized vignettes only ("a national energy major's exploration portfolio," "a private education group processing 1M+ documents/year"). Patterns are provable in interviews without names.
...
**Interview-ready milestone:** Phase 6 + figures F2/F3/F4 constitute a shippable artifact *before* full completion — sequence for that milestone given active processes.
